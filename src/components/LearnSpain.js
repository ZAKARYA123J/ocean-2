...
import OffrsSection from "./Spain/OffrsSection";
import AboutSection from "./Spain/AboutSection";
import CoursesSection from "./Spain/CoursesSection";
import WhySection from "./Spain/WhySection";
import TestSection from "./Spain/TestSection";
import FaqSection from "./Spain/FaqSection";
import LearnSpainEx from "./Spain/LearnSpainModel";
      ...
      >
        ...
        <div className="container mx-auto relative z-10 flex flex-col items-start text-left">
          ...
          <button
            ...
            style={{ backgroundColor: "#FF5733" }} // New button background color for Spanish page
          >
            Start Now
          </button>
              ...
              <div className="flex flex-col items-start">
                <div className="flex items-baseline">
                  <h3
                    ...
                    style={{
                      fontSize: "42px",
                      color: "#FF5733", // New color for Spanish page
