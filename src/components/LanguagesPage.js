...
import { SiTailwindcss, SiFigma, SiFlutter, SiNextdotjs, SiLaravel, SiExpress, SiMongodb, SiMysql } from 'react-icons/si';
            ...
            <section className="flex-grow pt-24">
                <div className="relative container mx-auto px-4 lg:px-8 max-w-7xl mt-10 flex flex-col lg:flex-row items-center justify-between">
                    <div className="relative flex justify-center items-center mb-10 lg:mb-0" style={{ height: `${containerSize}px`, width: `${containerSize}px` }}>
                        ...
                        <div className="absolute w-[80%] h-[80%] rounded-full bg-blue-400 opacity-20 wave-animation2"></div>

                        <ul className="relative flex items-center justify-center" style={{ width: `${containerSize}px`, height: `${containerSize}px` }}>
                            {loading ? (
                    ...
                    <div className="w-[560px] p-6 bg-white rounded-lg shadow-lg">
                        <h1 className="text-4xl font-bold text-gray-900 mb-2">
                            Meet Our <span className="text-indigo-600">Development Team</span>
                        </h1>
                        <p className="text-gray-600 mb-6">
                            Our team consists of highly skilled developers proficient in a variety of modern
                            technologies. We specialize in building robust web applications, mobile apps, and 
