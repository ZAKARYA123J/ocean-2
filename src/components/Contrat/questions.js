...
const loadClientData = (lang) => {
  switch (lang) {
    case 'fr':
      return import('./dataFR').then((module) => module.questionSectionContent);
    case 'ar':
      return import('./dataAR').then((module) => module.questionSectionContent);
    case 'en':
    default:
      return import('./dataEN').then((module) => module.questionSectionContent);
  }
};
...
const QuestionSection = () => {
  ...
  useEffect(() => {
    loadClientData(currentLanguage).then((data) => {
      setContent(data);
    });
  }, [currentLanguage]);
