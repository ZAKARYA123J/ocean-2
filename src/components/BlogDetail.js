    ...
    return (
        <>
            <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen p-4 lg:p-8">
                ...
                <div className="w-full lg:w-1/3 mb-10 lg:mb-40 p-6 bg-white rounded-lg shadow-lg flex flex-col justify-start items-center">
                    <p className="text-gray-500 mb-4 lg:mb-6 text-lg lg:text-2xl text-center">To register, simply click here</p>
