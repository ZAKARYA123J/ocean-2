...
function International() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 mt-10 px-10">
        {recruitmentData.map((job) => (
          <div key={job.id} className="flex bg-white shadow-md rounded-lg overflow-hidden">
            <img
              src={job.image}
              alt={job.position}
            ...
            <div className="p-4 flex flex-col justify-between w-full">
              ...
              <button className="flex items-center px-3 py-1.5 w-40 bg-blue-500 text-white text-xs font-medium rounded-md shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400">
